...
constexpr const char* kIconTextureId = "NexusGameWiki.Icon";
...
void PreparePaths()
{
    ...
    gState.IconPath = JoinPath(gState.AddonDirectory, "nexusgamewiki-icon.png");
...
void EnsureIconShortcut()
{
    ...
    if (!gState.IconPath.empty())
    {
        gState.Api->Textures.GetOrCreateFromFile(kIconTextureId, gState.IconPath.c_str());
    }
